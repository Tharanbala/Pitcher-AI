        ...
        <div className="flex justify-center p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl">
                <div className="max-w-sm rounded overflow-hidden shadow-lg bg-white">
                    <img className="w-full h-48 object-cover" src="https://example.com/member1.jpg" alt="Member 1"/>
                    <div className="px-6 py-4">
                        <div className="font-bold text-xl mb-2 text-black">Shubham Verma</div>
                    </div>
                    <div className="px-6 pt-4 pb-2 flex items-center justify-between">
                        <a href="https://linkedin.com/member1" className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">
                            <Linkedin />
                        </a>
                        <a href="https://twitter.com/member1" className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">
                            <Twitter />
                        </a>
